...
// After no swaps transactions occur for the period of 30 days, the swap loss offset period is increased by 1 day.
rule swapCostOffsetPeriodIncreaseByOne(env e, method f){
    calldataarg args;
    ...
    // using 1
    satisfy(assert_uint16(_swapCostOffsetPeriodGhostBefore + 1) == _swapCostOffsetPeriodGhostAfter);
}
