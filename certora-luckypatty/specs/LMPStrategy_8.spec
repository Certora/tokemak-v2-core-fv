...
// doc: https://tokemak.notion.site/Tokemak-Strategy-High-Level-Overview-Hats-certora-luckypatty-f2ddc0754ec74ed2a9572ddc02abcdbb#:~:text=maximum%20allowed%20value%20of%2050%20days.
invariant offsetEdges()
    50 == swapCostOffsetMaxInDays() && 10 == swapCostOffsetMinInDays();
