...
methods {
    ...
    function _.isDestinationQueuedForRemoval(address dest) external => isDestinationQueuedForRemovalOut expect bool;
...
ghost bool isDestinationQueuedForRemovalOut;
...
rule canSucceedWhenScenarios4Active(
    env e, IStrategy.RebalanceParams params, uint256 slippage
) {
    require isScenario4Active(e, params);
    require getmaxEmergencyOperationSlippage(e) > slippage;
    require getmaxShutdownOperationSlippage(e) > slippage;
    require getmaxNormalOperationSlippage(e) > slippage;
    require getmaxTrimOperationSlippage(e) < slippage;
    verifyRebalanceToIdleExternal@withrevert(e, params, slippage);
