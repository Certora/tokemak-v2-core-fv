...
contract LMPStrategy is ILMPStrategy, SecurityBase {
    ...
    {
        // mutation: switch decimals for tokenIn and tokenOut
        uint8 tokenOutDecimals = IERC20Metadata(params.tokenIn).decimals();
        uint8 tokenInDecimals = IERC20Metadata(params.tokenOut).decimals();
